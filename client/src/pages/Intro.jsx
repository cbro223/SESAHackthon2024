    ...
    <>
      <div style={{ backgroundImage: `url(${bgImage})` }} className="flex flex-col items-center justify-center g-cover bg-center w-full h-screen">
        <div className="flex flex-col items-center justify-center gap-9">
          <p className="text-3xl justify-center flex nunito-bold"> WELCOME TO </p>
          <p className="text-9xl justify-center bubbly flex drop-shadow-[2px_2px_10px_#c7b8bf]"> LUNAR LUCK </p>
